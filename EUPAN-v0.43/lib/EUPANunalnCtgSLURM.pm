...
my $usage="\nUsage: eupanSLURM getUnalnCtg [options]  <assembly_directory> <QUAST_assess_directory> <output_directory>

eupanSLURM getUnalnCtg is used to collect unaligned contigs.
...
my $usage="\nUsage: eupanSLURM mergeUnalnCtg [options]  <unaln_directory> <output.fa>  

eupanSLURM mergeUnalnCtg is used to merge unaligned contigs of each individuals to a single file.
";
