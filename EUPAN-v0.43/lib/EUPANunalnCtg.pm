...
my $usage="\nUsage: eupan getUnalnCtg [options]  <assembly_directory> <QUAST_assess_directory> <output_directory>
...
#obtain *.unaligned within quast dir
...
my $tf=$out_dir."total_unaln.fa";
mergeUnaln($out_data,$tf);
1;
}
