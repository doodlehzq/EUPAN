...
my $usage="\nUsage: eupanLSF assemble soapdenovo [options] <fastq_data_directory> <output_directory> <soapdenovo_directory>
...
my $usage="\nUsage: eupanLSF assemble linearK [options] <fastq_data_directory> <output_directory> <soapdenovo_directory>

eupanLSF assemble linearK is used to assemble high-quality reads on large scale.
