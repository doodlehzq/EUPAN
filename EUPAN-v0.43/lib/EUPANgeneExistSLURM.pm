...
my $usage="eupanSLURM geneExist gene_file cds_file min_gene_cov min_cds_cov >output
...
my $usage="eupanSLURM subSample gene_existence_matrix sample_list >output
";
...
my $usage="eupanSLURM gFamExist <geneExist.txt> <geneFam.info> > geneFamExist.txt
";
