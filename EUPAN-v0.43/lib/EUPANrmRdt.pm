...
sub rmRDT{
my $usage="eupan rmRedundant [commands]

eupan rmRedundant is used to cluster sequences and extract the representative ones.
...
my $usage="\nUsage: eupan rmRedundant cdhitCluster [options] <input_fasta_file> <output_directory> <cdhit_directory>
