...
my $usage="\nUsage: eupanSLURM bamSta basic [options]  <bam_directory> <output_directory> <bamUtil_directory>

eupanSLURM bamSta basic is used to check the basic statistics of mapping.
...
my $usage="\nUsage: eupanSLURM bamSta cov [options]  <bam_directory> <output_directory> <qualimap_directory>

eupanSLURM bamSta cov is used to check the coverages of the genome.
...
my $usage="\nUsage: eupanSLURM bamSta mergeBasicSta [options] <directory> >output

eupanSLURM bamSta mergeBasicSta is used to collect and merge bam basic statistics.
...
sub mergeCovSta{
    ...
    my $usage="\nUsage: eupanSLURM bamSta mergeCovSta [options] <directory> >output

eupanSLURM bamSta mergeCovSta is used to collect and merge bam coverage statistics.
