...
my $usage="\nUsage: eupanSLURM assemSta [options]  <assembly_directory> <output_directory> <QUAST_directory> <reference.fa>

eupanSLURM assemSta is used to map assembled contigs to reference and to check the statistics of assembled contigs (or scaffolds).
...
my $usage="\nUsage: eupanSLURM mergeAssemSta <QUAST_output_directory_list> > output_statistics

eupan SLURM mergeAssemSta is used to collect statistices info of assembly from quast.
