...
sub rmRDT{
my $usage="eupanLSF rmRedundant [commands]

eupanLSF rmRedundant is used to cluster sequences and extract the representative ones.
...
my $usage="\nUsage: eupanLSF rmRedundant cdhitCluster [options] <input_fasta_file> <output_directory> <cdhit_directory>
...
my $usage="\nUsage: eupanLSF rmRedundant blastCluster [options] <input_fasta_file> <output_directory> <blast_directory>
