...
my $usage="eupanLSF geneExist gene_file cds_file min_gene_cov min_cds_cov >output
...
my $usage="eupanLSF subSample gene_existence_matrix sample_list >output
";
...
my $usage="eupanLSF gFamExist <geneExist.txt> <geneFam.info> > geneFamExist.txt
";
