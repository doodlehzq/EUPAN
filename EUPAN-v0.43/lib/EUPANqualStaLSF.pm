...
sub checkQual{
    ...
    my $usage="\nUsage: eupanLSF qualSta [options] <data_directory> <output_directory>
...
sub mergeFastqc{
    use strict;
    use warnings;
    die "Usage: eupanLSF mergeQualSta <directory>
directory  <string>  The exact output of \"eupanLSF qualSta\".
" if @ARGV<1;
    my $out_dir=$ARGV[0];
    unless($out_dir=~/\/$/){
	$out_dir.="/";
