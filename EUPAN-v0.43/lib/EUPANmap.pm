...
my $usage="\nUsage: eupan align [options] <fastq_data_directory> <output_directory> <Mapping_tool_directory> <alignment_index>

eupan align is used to map high-quality reads to a reference on large scale.
